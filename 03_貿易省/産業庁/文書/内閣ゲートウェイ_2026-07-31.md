...
統治手帳（`03_貿易省/産業庁/任務盤/`）を国家OS・内閣の唯一の窓口にする。従来「総理」タブ（AIスマートラビットのみ）を「内閣」タブへ拡張し、13人格すべてと直接対話できるようにした。
...
- 新規: `03_貿易省/産業庁/任務盤/lib/cabinet-registry.cjs`（13人格のレジストリ）
...
- `05_情報省/ダヴィンチ図書館/`・`cabinet/chief_statecraft_minister.md` は未編集
