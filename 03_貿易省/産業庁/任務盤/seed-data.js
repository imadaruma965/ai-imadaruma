...
window.TASKBOARD_SEED = {
  ...
  tasks: [
    ...
    { title: "正本をChatGPT／Claudeへ再貼付", category: "personal", horizon: "week", urgency: "high", importance: "high", recurrence: "weekly", scheduleKey: "ops-ai-canon-sync", tags: ["forced", "ops", "ai-sync"], notes: "01_内閣府/ChatGPT用君主カード.md をCustom指示／Projectへ。戦略変更時は即。壁打ちはinboxへ。" },
