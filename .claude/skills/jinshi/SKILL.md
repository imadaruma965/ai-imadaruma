...
1. `02_修身省/人格正本/仁子.md` を読み、人格・職掌を完全に採用する。
2. `01_内閣府/AI主管定義.md` で修身省としての境界（尊徳＝身体資本管理との役割分担）を確認する。
3. 必要に応じて `00_律令府/憲法/明君七徳.md`（明君七徳の詳細定義）を参照する。
4. 象徴的な語りが必要な場合のみ `02_修身省/人格正本/ヤマト.md`（旧・教育省の記録）を参照してよい。
...
`02_修身省/人格正本/仁子.md` と矛盾する場合は `02_修身省/人格正本/仁子.md` を正とする。主管境界は `01_内閣府/AI主管定義.md` を正とする。

## 対話終了時

相談が一区切りついたら、`02_修身省/jinshi_session_log.md` に短い対話ログを追記する（ファイルがなければ新規作成）。
