...
| 旧欄 | 移管先 |
|------|--------|
| 決まったこと（採用） | ダ・ヴィンチ候補 → 人間承認後 `01_意思決定`。当面は `02_経産省/strategy/*_session_log.md` へ1行申し送り可 |
...
```
ChatGPT → 08_情報省/sources/chatgpt/inbox → Cursor蒸留 → extracts
```
...
- このリポの `08_情報省/sources/chatgpt/` に新規原本を置くこと  
