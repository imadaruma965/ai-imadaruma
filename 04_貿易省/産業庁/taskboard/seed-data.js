...
window.TASKBOARD_SEED = {
  ...
  tasks: [
    ...
    { title: "正本をChatGPT／Claudeへ再貼付", category: "personal", horizon: "week", urgency: "high", importance: "high", recurrence: "weekly", scheduleKey: "ops-ai-canon-sync", tags: ["forced", "ops", "ai-sync"], notes: "01_首相官邸/monarch_profile_chatgpt.md をCustom指示／Projectへ。戦略変更時は即。壁打ちはinboxへ。" },
